-- =============================================
-- Creación de Base de Datos EurabankDb
-- =============================================

-- Crear la base de datos si no existe
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'EurabankDb')
BEGIN
    CREATE DATABASE EurabankDb;
END
GO
...
-- =============================================
-- Creación de los Objetos de la Base de Datos para SQL Server
-- =============================================
...
CREATE TABLE cuenta (
	...
	FOREIGN KEY (chr_sucucodigo) REFERENCES sucursal (chr_sucucodigo),
	FOREIGN KEY (chr_monecodigo) REFERENCES modena (chr_monecodigo)
);
...
PRINT 'Base de datos EurabankDb y tablas creadas exitosamente';
