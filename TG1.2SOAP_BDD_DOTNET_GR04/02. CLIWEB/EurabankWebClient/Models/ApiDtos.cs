...
{
    // DTOs que coinciden con el servidor REST
    ...
    {
        public string CodigoCuenta { get; set; } = string.Empty;
        public string CodigoEmpleado { get; set; } = "0001"; // Usuario del sistema
        public string CodigoTipo { get; set; } = string.Empty;
        public decimal Importe { get; set; }
        public string? CuentaReferencia { get; set; }
    }
    ...
    public class TipoMovimientoDto
    {
        ...
        public string Accion { get; set; } = string.Empty; // INGRESO o SALIDA
    }
}
