 ...
 * generated in the ec.edu.gr03.controller package. 
...
public class ObjectFactory {
    ...
    private final static QName _Cuenta_QNAME = new QName("http://controller.eurekabank.edu.ec/", "cuenta");
    ...
    private final static QName _TraerBalances_QNAME = new QName("http://controller.eurekabank.edu.ec/", "traerBalances");
    private final static QName _TraerBalancesResponse_QNAME = new QName("http://controller.eurekabank.edu.ec/", "traerBalancesResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ec.edu.gr03.controller
     * 
     */
    ...
    /**
     * Create an instance of {@link TraerBalances }
     * 
     */
    public TraerBalances createTraerBalances() {
        return new TraerBalances();
    }

    /**
     * Create an instance of {@link TraerBalancesResponse }
     * 
     */
    public TraerBalancesResponse createTraerBalancesResponse() {
        return new TraerBalancesResponse();
    }
     ...
     */
    @XmlElementDecl(namespace = "http://controller.eurekabank.edu.ec/", name = "cuenta")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TraerBalances }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link TraerBalances }{@code >}
     */
    @XmlElementDecl(namespace = "http://controller.eurekabank.edu.ec/", name = "traerBalances")
    public JAXBElement<TraerBalances> createTraerBalances(TraerBalances value) {
        return new JAXBElement<TraerBalances>(_TraerBalances_QNAME, TraerBalances.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TraerBalancesResponse }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link TraerBalancesResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://controller.eurekabank.edu.ec/", name = "traerBalancesResponse")
    public JAXBElement<TraerBalancesResponse> createTraerBalancesResponse(TraerBalancesResponse value) {
        return new JAXBElement<TraerBalancesResponse>(_TraerBalancesResponse_QNAME, TraerBalancesResponse.class, null, value);
    }
