...
public class RetiroFrm extends javax.swing.JFrame {
    ...
    public RetiroFrm() {
        ...
        JLabel lblTitle = new JLabel("REALIZAR RETIRO");
        ...
        btnRetirar = new JButton("Retiro");
        btnRetirar.setFont(new Font("Segoe UI", Font.BOLD, 16));
        btnRetirar.setBackground(COLOR_RETIRO);
        ...
        // Listeners
        btnRetirar.addActionListener(e -> btnRetirarActionPerformed());
    ...
    private void btnRetirarActionPerformed() {
        ...
        try {
            ...
            int resultado = ec.edu.gr03.controller.EurekaBankClient.regRetiro(cuenta, importe);
            if (resultado == 1) {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> new RetiroFrm().setVisible(true));
    }
}
