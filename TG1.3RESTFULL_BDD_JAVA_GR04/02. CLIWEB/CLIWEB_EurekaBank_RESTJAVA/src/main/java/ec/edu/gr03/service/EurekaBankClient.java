 ...
 * 1. Asegurarse que el servidor REST esté corriendo en http://10.40.27.110:8080/eurekabank/
 * 2. El servidor debe tener todos los endpoints REST configurados
 */
public class EurekaBankClient {
    
    private static final String BASE_URI = "http://10.40.27.110:8080/eurekabank/api/eureka";
